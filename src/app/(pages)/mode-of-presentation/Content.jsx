        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-[#4d724d] mb-8">
              Learn about the different ways to present your research at {CONFERENCE.shortForm}
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="mb-6 md:mb-0 md:mr-6">
                ...
                <p className="text-[#4d724d] max-w-xl">
                  Choose your preferred presentation mode and submit your proposal for {CONFERENCE.shortForm} {CONFERENCE.year} today. We look forward to showcasing your innovative research and fostering meaningful discussions at the conference!
                </p>
              </div>
