...
const scheduleData = [
  {
    ...
    items: [
      ...
      { time: "9:25AM - 9:35AM", title: "Dr. Liane Vina G Ocampo, Cavite State University" },
      { time: "9:35AM - 9:40AM", title: "Dr. Rania D. Abduraup, Sulu State College" },
      { time: "9:40AM - 9:45AM", title: "Speech by Conference Co-Chair — Dr. Sherha Ballaho Baybayan, Sulu State College" },
      { time: "9:45AM - 9:55AM", title: "Speech by Conference Chair — Dr. Wilson Cordova, LPT, CRS, De La Salle University" },
      { time: "9:55AM - 10:00AM", title: "Dr. Frissida Asid-Daud, RN, MAN, PhD, Sulu State College" },
      { time: "10:00AM - 10:20AM", title: "☕ Tea Break" },
      { time: "10:20AM - 10:35AM", title: "Keynote Speech by Prof. Charisma Samparani Ututalum" },
      { time: "10:35AM - 10:50AM", title: "Keynote Speech by Dr. Waiphot Kulachai" },
      { time: "10:50AM - 11:00AM", title: "Session Speech by Dr. Daisy M. Galgana" },
      { time: "11:00AM - 1:00PM", title: "Technical Session 1 (Sustainability)" },
      { time: "1:00PM - 2:00PM", title: "🍽️ Lunch Break" },
      { time: "2:00PM - 2:10PM", title: "Session Speech by Dr. Veronica Sarcino-Almase" },
      { time: "2:00PM - 3:30PM", title: "Technical Session 2 (Innovation and Future Technology)" },
      { time: "3:30PM - 4:00PM", title: "☕ Tea Break" },
      { time: "4:00PM - 5:00PM", title: "Panel Discussion" },
  ...
  },
  {
    ...
    items: [
      { time: "8:30AM - 9:00AM", title: "Registration" },
      { time: "9:00AM - 9:20AM", title: "Introduction by Moderator" },
      { time: "9:20AM - 9:25AM", title: "Welcome Speech by Organizing Secretary — Dr. Rania D. Abduraup, Sulu State College" },
      { time: "9:25AM - 9:30AM", title: "Speech by Conference Co-Chair" },
      { time: "9:30AM - 9:35AM", title: "Speech by Conference Chair" },
      { time: "9:35AM - 9:50AM", title: "Keynote Speech by Prof. Marina Falasca" },
      { time: "9:50AM - 10:05AM", title: "Keynote Speech by Helen Boholano" },
      { time: "10:20AM - 10:40AM", title: "☕ Tea Break" },
      { time: "10:40AM - 10:55AM", title: "Keynote Speech by Desiderio R. Apag III" },
      { time: "10:55AM - 11:05AM", title: "Session Speech by Malikha Ilupa, RAgr, MSA" },
      { time: "11:05AM - 12:00PM", title: "Technical Session 1 (Sustainability)" },
      { time: "12:30PM - 1:30PM", title: "🍽️ Lunch Break" },
      { time: "1:30PM - 1:40PM", title: "Session Speech by Marjohn Villamor Anislag, PhD" },
