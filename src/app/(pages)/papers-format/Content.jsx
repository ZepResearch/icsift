          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-[#4d724d] mb-4">
                All submissions to ICSIFT 2025 must follow our formatting guidelines to ensure consistency and
        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div>
              ...
              <p className="text-[#4d724d] mb-4">
                ICSIFT 2025 uses the IEEE citation style for all submissions. Please ensure that your references are
            ...
            <div className="flex flex-col md:flex-row items-center justify-between">
              <div className="mb-6 md:mb-0 md:mr-6">
                ...
                <p className="text-[#4d724d] max-w-xl">
                  Download the appropriate template and prepare your submission for ICSIFT 2025.
                </p>
              </div>
